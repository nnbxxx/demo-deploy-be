...
class UpdateColorDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { _id: { required: true, type: () => String }, color: { required: true, type: () => String } };
    }
}
...
], UpdateColorDto.prototype, "_id", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: "Màu phải là chuỗi" }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Ảnh không được để trống' }),
    __metadata("design:type", String)
], UpdateColorDto.prototype, "color", void 0);

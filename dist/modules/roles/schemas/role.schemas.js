...
const permission_schemas_1 = require("../../permissions/schemas/permission.schemas");
let Role = class Role {
};
exports.Role = Role;
__decorate([
...
__decorate([
    (0, mongoose_1.Prop)({ type: [mongoose_2.default.Schema.Types.ObjectId], ref: permission_schemas_1.Permission.name }),
